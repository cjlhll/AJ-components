(function (window) {
  ...
  let w = window.innerWidth-40 // canvas宽度
  let curSlideText='向右滑动滑块填充拼图'
  ...
  function getRandomImg() {
    // return require(`../../static/reg-bj${Math.floor(Math.random()*8)+1}.jpg`);
    return 'https://picsum.photos/300/150/?image=' + getRandomNumberByRange(0, 1084)
    // return require('./login.jpg')
    //  return require('./login'+getRandomNumberByRange(0, 1)+'.jpg')
  }
  ...
  class jigsaw {
    constructor({el , slideText , onSuccess, onFail, onRefresh}) {
      console.log(slideText);
      curSlideText=slideText;
      w=el.clientWidth
      this.el = el
    ...
    initDOM() {
      ...
      text.innerHTML = curSlideText || '向右滑动滑块填充拼图'
    ...
    bindEvents() {
      ...
      let originX, originY, trail = [], isMouseDown = false
        this.slider.addEventListener('touchstart', function (e) {
            originX = e.targetTouches[0].clientX, originY = e.targetTouches[0].clientY
            isMouseDown = true
        })
